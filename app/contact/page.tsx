...
const Page = () => {
  return (
    <div className="flex h-full">
      <div className="sm:min-w-[288px] min-w-full flex-[0_0_16%] h-full">
        <details
          className="flex items-center gap-2 border-b border-b-line-color border-r h-full border-r-line-color"
          open
        >
          <summary className="px-4 py-3 border-b cursor-pointer border-b-line-color">
            contacts
          </summary>
          <div className="px-4 py-5 text-primary-gray">
            ...
            <Link href="https://t.me/reactcoder" target="_blank" className="flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width="16"
